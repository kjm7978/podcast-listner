...
export class PodcastsResolver {
  ...
  @Mutation(returns=>SearchPodcastOutput)
  @Role(["Listener"])
  serachPodcasts(@Args("input") searchPodcastInput:SearchPodcastInput):Promise<SearchPodcastOutput>{
  ...
  subscribeToPodcast(
    ...
    return this.podcastsService.subscribeToPodcast(authUser,subscribePodcastInput);
  }
  ...
  seeSubscriptions(
    ...
    return this.podcastsService.seeSubscriptions(authUser);
  }
